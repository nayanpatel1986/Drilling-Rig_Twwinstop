...
# Try querying exactly the known latest data time
start_time = "2026-02-27T06:21:30.0000000+05:30"
...
if result.XMLout:
    ...
    if data_nodes:
        print("First row datetime:", data_nodes[0].text.split(',')[0])
        print("Last row datetime:", data_nodes[-1].text.split(',')[0])
else:
    print("No data found.")
